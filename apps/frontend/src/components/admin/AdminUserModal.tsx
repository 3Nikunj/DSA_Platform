    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-screen overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          {/* Gamification Stats */}
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Gamification Stats</h3>
          ...
          {/* Permissions & Status */}
          <div>
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Permissions & Status</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  Role
